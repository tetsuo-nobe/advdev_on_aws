...
1. **Creation options** で **Build custom pipeline** を選択して **次へ** へをクリックします。
...
1. ページ下部で **詳細** タブが選択されていることを確認し、**パブリックIPv4 DNS** の値をコピーします。
...
1. ページ下部の **作成者名** に 現在使用している IAM ユーザー名、**E メールアドレス** に `dummy@example.com` と入力します。
